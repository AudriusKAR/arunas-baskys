...
{tipai}            </select>
          ...
          <div class="field">
            ...
            <input type="text" id="modelis" placeholder="Pvz., Daikin Altherma 3">
            <div class="hint">
        ...
        <div class="form-section">
          ...
          <div class="field">
            ...
            <input type="text" id="klaida" placeholder="Pvz., E-04, U4, 7H">
          </div>
          <div class="field">
            <label for="simptomai">Simptomai ir situacija <span class="req">*</span></label>
            <textarea id="simptomai" required placeholder="Išsamiai aprašykite, kas vyksta. Kada prasidėjo problema? Ar atsiranda specifinėmis sąlygomis? Ar jau buvo taisyta, kokios detalės keistos?"></textarea>
            <div class="hint">
              <span class="ms ms-sm">info</span>
        ...
        <div class="form-section">
          ...
          <div class="field">
            ...
            <input type="text" id="vardas" required autocomplete="name">
            <div class="err-msg">Įrašykite vardą</div>
          </div>
          <div class="field">
            <label for="telefonas">Telefonas <span class="req">*</span></label>
            <input type="tel" id="telefonas" required placeholder="+370..." autocomplete="tel">
            <div class="err-msg">Įrašykite telefono numerį</div>
          </div>
          <div class="field">
            <label for="elpastas">El. paštas</label>
            <input type="email" id="elpastas" placeholder="vardas@pastas.lt" autocomplete="email">
          </div>
          <div class="field">
            <label for="adresas">Objekto adresas (miestas / rajonas) <span class="req">*</span></label>
            <input type="text" id="adresas" required placeholder="Pvz., Vilnius, Antakalnis">
    ...
    <div class="form-done" id="form-done">
      ...
      <p class="form-note" style="text-align:left; margin-top:24px">
        <a href="#" id="back-to-form" style="color:var(--eng-blue)">← Grįžti ir pataisyti duomenis</a>
      </p>
    </div>
  </div>
</section>
